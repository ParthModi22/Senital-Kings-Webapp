...
# Load the generative model and generate content
    ...
    response = model.generate_content(f"explain about {crop} and its water needs in following latitude and longitude: {lat:.2f} and {long:.2f} at {stage} growth stage and give output in a single para in {language} in 00 words. Don't mention coordinates, only place name")  
